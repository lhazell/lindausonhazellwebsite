# Django settings for lindauson project.
import os
...
SECRET_KEY = '$^l046elew&e+&%tp0$qfc_dche4py%p23+%y+@#-u83(2!g6h'
...
ROOT_URLCONF = 'lindauson.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'lindauson.wsgi.application'
